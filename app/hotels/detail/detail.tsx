...
function HotelDetail() {
  ...
  useEffect(() => {
    ...
    fetch(`https://traveltripo.com/travel-api/frontend/hotel-details.php?id=${id}`,
      {
        method: "GET",
                ...
                <div className="tourdetail-tabs tabs-box">
                  ...
                  <div className="tabs-content">
                    ...
                    <div className="tab active-tab" id="tour-description">
                        ...
                        <div className="row clearfix">
                          ...
                          <div className="column col-lg-12 col-md-12 col-sm-12">
                            ...
                            <p>
                              ...
                              <p>{alldata?.discription || 'No description available'}</p>
                            </p>
                          </div>
                      ...
                      <div className="content">
                        <h3 className="pt-0">Amenities</h3>
                        <div className="row clearfix">

                          <div className="column col-lg-12 col-md-12 col-sm-12">
                            <ul className="tour-detail_lists-two">
                              <li className={`${hideItem1 ? 'hideLabel' : 'showLabel'}`}><label><img src="/assets/images/am1.png" /> Air Condition </label> <span className="hideItem">{alldata?.air_condition}</span></li>
                              <li className={`${hideItem2 ? 'hideLabel' : 'showLabel'}`}><label><img src="/assets/images/am2.png" /> Fridge</label>  <span className="hideItem">{alldata?.fridge}</span></li>
                              <li className={`${hideItem3 ? 'hideLabel' : 'showLabel'}`}><label><img src="/assets/images/am3.png" /> Attached Washroom</label> <span className="hideItem">{alldata?.attached_washroom}</span></li>
                              <li className={`${hideItem4 ? 'hideLabel' : 'showLabel'}`}><label><img src="/assets/images/am4.png" /> Microwave</label>  <span className="hideItem">{alldata?.microwave}</span></li>
                              <li className={`${hideItem5 ? 'hideLabel' : 'showLabel'}`}><label><img src="/assets/images/am5.png" /> Car Parking</label>  <span className="hideItem">{alldata?.car_parking}</span></li>
                              <li className={`${hideItem6 ? 'hideLabel' : 'showLabel'}`}><label><img src="/assets/images/am6.png" /> Swiming Pool</label>  <span className="hideItem">{alldata?.swiming_pool}</span></li>
                              <li className={`${hideItem7 ? 'hideLabel' : 'showLabel'}`}><label><img src="/assets/images/am7.png" /> Indoor Gym</label> <span className="hideItem"> {alldata?.indoor_gym}</span></li>
                        ...
                        (
                          <div className="content">
                            ...
                            <div className="tour-detail_map">
                              ...
                              {
                                <iframe className="map" src={alldata?.map}></iframe>
                        ...
                        <div className="row clearfix">
                          ...
                          <div className="column col-lg-12 col-md-12 col-sm-12">
                            ...
                            <p>
                              ...
                              {alldata?.policy || 'No policy available'}
