...
function Home() {
  ...
  useEffect(() => {
    ...
    fetch(`https://traveltripo.com/travel-api/frontend/hotel-list-by-city.php?city=${selectedCity}`)
                            ...
                            <div className="card-detail">
                              ...
                              <div className="card-info">
                                ...
                                <div className="hotel-distance">
                                  <b><i className="fa fa-map-marker"></i> {items.city} - ({items.landmark})</b>
                                </div>
                                <div className="hotel-price">
                                  <b>&#8377; {items.price} / <small className="textSmall">Per Night</small></b>
                                </div>
