...
function Home() {
  ...
  useEffect(() => {
    ...
    fetch(`https://traveltripo.com/travel-api/frontend/package-list-by-city.php?city=${selectedCity}`)
  ...
  const bookingHandler = (id: string | number, price: number) => {
    router.push(`/packages/detail?id=${id}&price=${price}`);
  };
                            ...
                            <div className="card-detail">
                              ...
                              <div className="card-info">
                                ...
                                <div className="hotel-price">
                                  <b>&#8377; {items.price} / <small className="textSmall">Per Person</small></b>
                                </div>
